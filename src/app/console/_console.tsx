        ...
        <div ref={pickerRef} className="relative ml-2">
          ...
          >
            {activeVm ? (
              <>
                <Circle
                  className={`h-2 w-2 shrink-0 ${activeVm.poweredOn ? "fill-status-success text-status-success" : "fill-zinc-500 text-zinc-500"}`}
                />
              ...
              {loading ? (
                ...
                vms.map((vm) => (
                  ...
                  >
                    ...
                    >
                      <Circle
                        className={`h-2 w-2 shrink-0 ${vm.poweredOn ? "fill-status-success text-status-success" : "fill-zinc-600 text-zinc-600"}`}
                      />
