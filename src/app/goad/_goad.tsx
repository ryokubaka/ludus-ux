...
export function GoadPageClient() {
        ...
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-start gap-4">
              <div className="h-10 w-10 rounded-lg bg-status-success/20 flex items-center justify-center flex-shrink-0">
              ...
              {loading ? (
                ...
                <Card>
                  <CardContent className="flex flex-col items-center py-12 text-muted-foreground">
                    <div className="h-14 w-14 rounded-full bg-status-success/10 flex items-center justify-center mb-3">
                      <Terminal className="h-7 w-7 text-status-success" />
                    </div>
                ...
                {adminLoading ? (
                  ...
                  <Card>
                    <CardContent className="flex flex-col items-center py-10 text-muted-foreground">
                      <Terminal className="h-7 w-7 text-status-success mb-2" />
                                ...
                                >
                                  <td className="p-3">
                                    <div className="flex items-center gap-2">
                                      {needsAttention && <AlertTriangle className="h-3 w-3 text-status-warning shrink-0" />}
                                      <Link
                                  ...
                                  <td className="p-3">
                                    {inst.ludusRangeId ? (
                                      ...
                                      <span className="text-xs text-status-warning/80 flex items-center gap-1">
                                  ...
                                  <td className="p-3 text-right">
                                    <Button
                                      ...
                                      className={cn(
                                        "h-7 text-xs gap-1",
                                        needsAttention
                                          ? "border-yellow-500/30 text-status-warning hover:bg-yellow-500/10"
                      ...
                      <CardContent className="p-3">
                        <div className="flex items-start justify-between gap-2 mb-1">
                          <div className="flex items-center gap-1.5">
                            {task.status === "running" ? (
                              <Activity className="h-3.5 w-3.5 text-status-success animate-pulse flex-shrink-0" />
                            ) : (
            ...
            <CardContent className="p-6 space-y-4">
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 rounded-lg bg-yellow-500/10 flex items-center justify-center flex-shrink-0">
                  <UserCog className="h-5 w-5 text-status-warning" />
                </div>
                <div>
