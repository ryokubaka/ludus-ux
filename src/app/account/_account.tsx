              ...
              <div className="flex gap-2 flex-wrap">
                ...
                {(avatarUrl && !pendingFile) && (
                  <Button
                    variant="ghost"
                    size="sm"
                    className="gap-1.5 text-status-error hover:text-status-error hover:bg-status-error/10"
        ...
        <CardContent className="space-y-4">
          {pwSuccess && (
            <Alert className="border-status-success/30 bg-status-success/10">
              ...
              <AlertDescription className="text-status-success text-xs">
          ...
          <div className="space-y-1.5">
            <Label htmlFor="account-current-password" className="text-xs">Current Password</Label>
          ...
          <div className="space-y-1.5">
            <Label htmlFor="account-new-password" className="text-xs">New Password</Label>
            <div className="flex gap-2">
              <Input
                ...
                className={cn("flex-1", pwTooShort && "border-status-warning/60")}
          ...
          <div className="space-y-1.5">
            <Label htmlFor="account-confirm-password" className="text-xs">Confirm New Password</Label>
            <Input
              ...
              className={cn(pwMismatch && "border-status-error/60")}
              autoComplete="new-password"
            />
            {pwMismatch && (
