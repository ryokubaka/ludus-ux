        ...
        <div className={cn(
          ...
          {!collapsed && (
            <div className="flex flex-col gap-0.5">
              <p className="text-xs font-semibold text-muted-foreground">v0.9.1 <span className="font-normal text-muted-foreground/60">beta</span></p>
          ...
          {collapsed && (
            <Tooltip>
              ...
              <TooltipContent side="right">v0.9.1 beta — Open Source · Apache 2.0</TooltipContent>
            </Tooltip>
          )}
          <Tooltip>
            <TooltipTrigger asChild>
